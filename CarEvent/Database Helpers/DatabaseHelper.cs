...
namespace CarEvent.Database_Helpers
{
    public class DatabaseHelper
    {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        Events evt = new Events(eventID, eventName, description, eventDate, location, image, ticketPrice);
        ...
        public List<Bookings> LoadBookings()
        {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        Bookings bookedEvent = new Bookings(eventID, participantID, noOfParticipants, total)
                        {
                            Id = bookingID
                        };
